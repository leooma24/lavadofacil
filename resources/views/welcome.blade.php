    ...
    <nav id="navbar" class="fixed top-0 w-full z-50 transition-all duration-300 border-b border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
            <a href="/" class="flex items-center gap-2">
                <img src="{{ asset('images/lavadofacil_logo.png') }}" alt="LavadoFácil" class="h-11" style="mix-blend-mode:screen;filter:brightness(1.1)">
            </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-10 mb-12">
                <div class="md:col-span-2">
                    <img src="{{ asset('images/lavadofacil_logo.png') }}" alt="LavadoFácil" class="h-12 mb-5" style="mix-blend-mode:screen;filter:brightness(1.1)">
